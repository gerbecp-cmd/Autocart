...
val configuredVersionCode = (project.findProperty("AUTOCART_VERSION_CODE") as String?)?.toIntOrNull() ?: 320
val configuredVersionName = (project.findProperty("AUTOCART_VERSION_NAME") as String?) ?: "3.2.0"
